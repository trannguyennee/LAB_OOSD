...
namespace QuanLyThuVien.Forms
{
    public partial class FrmDanhMuc : Form
    {
        ...
        {
            ShowResult(service.LuuNhanVien(new NhanVien
            {
        ...
        {
            if (XacNhanXoa())
                ShowResult(service.Xoa("NhanVien", "MaNhanVien", txtNVMa.Text.Trim()));
        }
        ...
        {
            ShowResult(service.LuuTheLoai(txtTLMa.Text, txtTLTen.Text, false));
        }

        private void btnTLCapNhat_Click(object sender, EventArgs e)
        {
            ShowResult(service.LuuTheLoai(txtTLMa.Text, txtTLTen.Text, true));
        }

        private void btnTLXoa_Click(object sender, EventArgs e)
        {
            if (XacNhanXoa())
                ShowResult(service.Xoa("TheLoai", "MaTheLoai", txtTLMa.Text.Trim()));
        }
        ...
        {
            ShowResult(service.LuuNhaXuatBan(txtNXBMa.Text, txtNXBDiaChi.Text, txtNXBSDT.Text, false));
        }

        private void btnNXBCapNhat_Click(object sender, EventArgs e)
        {
            ShowResult(service.LuuNhaXuatBan(txtNXBMa.Text, txtNXBDiaChi.Text, txtNXBSDT.Text, true));
        }

        private void btnNXBXoa_Click(object sender, EventArgs e)
        {
            if (XacNhanXoa())
                ShowResult(service.Xoa("NhaXuatBan", "MaNhaXuatBan", txtNXBMa.Text.Trim()));
        }
