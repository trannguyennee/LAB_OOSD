                                  ...
                                  string tinhTrang, decimal phiPhat)
        {
            ...
            using (SqlTransaction tx = cn.BeginTransaction(IsolationLevel.Serializable)) 
            {
                try
                {
                    ...
                    bool binhThuong = tt.Equals("Bình thường", StringComparison.OrdinalIgnoreCase) || 
                                      tt.Equals("Binh thuong", StringComparison.OrdinalIgnoreCase);
                    bool mat = !binhThuong && (tt.Equals("Mất", StringComparison.OrdinalIgnoreCase) || 
                                               tt.Equals("Mat", StringComparison.OrdinalIgnoreCase) || 
                                               tt.IndexOf("Mất", StringComparison.OrdinalIgnoreCase) >= 0 || 
                                               tt.IndexOf("Mat", StringComparison.OrdinalIgnoreCase) >= 0);
                    bool huHong = !binhThuong && !mat && (tt.IndexOf("Rách", StringComparison.OrdinalIgnoreCase) >= 0 || 
                                                           tt.IndexOf("Rach", StringComparison.OrdinalIgnoreCase) >= 0 || 
                                                           tt.IndexOf("Hư hỏng", StringComparison.OrdinalIgnoreCase) >= 0 || 
                                                           tt.IndexOf("Hu hong", StringComparison.OrdinalIgnoreCase) >= 0);
