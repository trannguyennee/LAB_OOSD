            ...
            using (var tx = cn.BeginTransaction())
            {
                try
                {
                    ...
                    if (string.IsNullOrWhiteSpace(so))
                    {
                        ...
                        var h = new SqlCommand(@"INSERT INTO PhieuSuDungDV(SoPhieuSDDV, SoPhieuDat, SoPhong, NgaySuDung, MaNV) 
                                                 VALUES(@so, @s, @p, @n, @nv)", cn, tx);
                    ...
                    {
                        var i = new SqlCommand(@"INSERT INTO ChiTietPhieuSuDungDV(SoPhieuSDDV, MaDV, SoLuong, DonGia) 
                                                 VALUES(@so, @d, @sl, @g)", cn, tx);
