...
namespace QuanLyKhachSan.Services
{
    public class PhongTienNghiService
    {
        ...
        {
            return Db.Query(@"SELECT t.MaTienNghi, l.TenLoaiTN, t.SoThuTu, t.TinhTrangHienTai, t.MaLoaiTN 
                             FROM TienNghi t 
        ...
        {
            return Db.Query(@"SELECT p.SoPhieuLapDat, p.MaTienNghi, l.TenLoaiTN, p.SoPhong, p.NgayLap, p.TinhTrang, nv.HoTen AS TenNV, p.GhiChu, p.MaNV 
                             FROM PhieuLapDat p 
        ...
        public KetQuaXuLy ThemTienNghi(string ma, string loai, int stt, string tt)
        {
            ...
            try
            {
                Db.Execute("INSERT INTO TienNghi(MaTienNghi, MaLoaiTN, SoThuTu, TinhTrangHienTai) VALUES(@m, @l, @s, @t)",
                    ...
                    new SqlParameter("@t", (object)tt ?? DBNull.Value));
        ...
        public KetQuaXuLy LapDat(string soPhieu, string maTN, string soPhong, DateTime ngay, string tinhTrang, string maNV, string ghiChu)
        {
            ...
            try
            {
                Db.Execute("INSERT INTO PhieuLapDat(SoPhieuLapDat, MaTienNghi, SoPhong, NgayLap, TinhTrang, MaNV, GhiChu) VALUES(@p, @tn, @ph, @n, @tt, @nv, @g)",
            ...
            catch (SqlException ex)
            {
                ...
                return KetQuaXuLy.Fail("Lỗi CSDL: " + ex.Message);
            }
            catch (Exception ex)
            {
                return KetQuaXuLy.Fail("Lỗi: " + ex.Message);
